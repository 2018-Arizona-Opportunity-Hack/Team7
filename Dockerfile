...
RUN apt-get install -y gnupg2 software-properties-common apt-transport-https curl libxml2-dev libgdal-dev
...
RUN su - -c "R -e \"install.packages(c('shiny', 'shinydashboard', 'exams', 'rlist', 'knitr', 'RSAGA', 'pathological', 'ECharts2Shiny'), repos = 'http://cran.rstudio.com/')\""
